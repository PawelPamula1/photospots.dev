...
const DownloadButtons = () => {
  ...
  const handleDownloadClick = (platform: "ios" | "android") => {
    ...
    const urls = {
      ios: "https://apps.apple.com/pl/app/photospots-hidden-gems/id6753591460",
    ...
    <div className="mt-4 md:mt-8 w-full max-w-2xl mx-auto">
      <div className="flex flex-col sm:flex-row items-center justify-center gap-3 md:gap-4 px-2">
        ...
        >
          ...
          {/* Content */}
          <div className="cursor-pointer relative px-5 py-3 md:px-8 md:py-4 flex items-center justify-center sm:justify-start gap-3 md:gap-4">
            {/* Apple Icon */}
            <svg
              className="w-7 h-7 md:w-10 md:h-10 text-white drop-shadow-lg flex-shrink-0"
              viewBox="0 0 24 24"
              fill="currentColor"
            >
        ...
        {/* Android Google Play Button - Coming Soon */}
        <div className="relative w-full sm:w-auto overflow-hidden rounded-xl md:rounded-2xl opacity-60 cursor-not-allowed">
          {/* Gradient background - muted */}
          <div className="absolute inset-0 bg-gradient-to-br from-[#01875f] via-[#34a853] to-[#fbbc04] opacity-50" />
